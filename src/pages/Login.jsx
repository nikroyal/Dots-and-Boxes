    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <form onSubmit={submit} className="w-full max-w-sm fade-in">
        <div className="text-center mb-12">
          ...
          <div className="mt-6 mx-auto" style={{ width: 40, height: 1, background: 'rgba(26,26,26,0.2)' }} />
        </div>
        ...
        <div className="flex gap-1 mb-8">
          {['login', 'signup'].map(m => (
            <button
              ...
              style={{
                borderBottom: `1px solid ${mode === m ? '#1A1A1A' : 'rgba(26,26,26,0.1)'}`,
        ...
        {error && (
          <div className="font-mono text-xs text-center mt-6" style={{ color: '#B91C3C' }}>
            {error}
          </div>
        )}
