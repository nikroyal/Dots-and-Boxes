    ...
    <div className="fade-in space-y-8">
      ...
      {history.length === 0 ? (
        ...
        <section className="border hairline">
          {history.map((h, i) => {
            const resultColor = h.result === 'win' ? '#2F6B3F' : h.result === 'loss' ? '#B91C3C' : '#B7791F';
            ...
            return (
              <Link key={i} to={`/replay/${h.matchId}`} onClick={sfx.click}
                ...
                <div className="text-right shrink-0">
                  ...
                  <div className="font-mono text-[0.65rem] tracking-widest tabular-nums" style={{ color: h.eloDelta >= 0 ? '#2F6B3F' : '#B91C3C' }}>
