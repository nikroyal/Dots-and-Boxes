  ...
  return (
    <div className="fade-in space-y-8">
      <section>
        ...
        <div className="mt-4 h-1 w-full max-w-md" style={{ background: 'rgba(26,26,26,0.1)' }}>
          <div className="h-full transition-all duration-500" style={{ width: `${progress}%`, background: '#1A1A1A' }} />
        </div>
      </section>
          ...
          return (
            <div key={a.id} className="border hairline p-4 transition-all" style={{ opacity: got ? 1 : 0.4 }}>
              <div className="flex items-start justify-between gap-3">
                ...
                {got && (
                  <div className="font-mono text-[0.6rem] tracking-widest uppercase shrink-0" style={{ color: '#2F6B3F' }}>
                    ✓ DONE
                  </div>
                )}
              </div>
